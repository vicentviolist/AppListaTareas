<template>
  <q-layout view="lHh Lpr lFf">
    <q-header>
      ...
      <q-img src="statics/fondospace.jpg" class="header-image absolute-top" />
    </q-header>
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above :width="250" :breakpoint="600">
      ...
      <q-img class="absolute-top" src="statics/fondospace.jpg" style="height: 185px">
        <div class="absolute-bottom bg-transparent">
          <q-avatar size="56px" class="q-mb-sm">
            <img src="https://cdn.quasar.dev/img/boy-avatar.png" />
          </q-avatar>
          <div class="text-weight-bold">Vicente Olivares</div>
          <div>@VicentViolist</div>
        </div>
      </q-img>
    </q-drawer>
